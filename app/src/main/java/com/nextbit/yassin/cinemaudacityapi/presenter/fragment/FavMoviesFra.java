...
import com.nextbit.yassin.cinemaudacityapi.presenter.recycleviewadapter.FavAdapter;
...
public class FavMoviesFra extends Fragment {
    ...
    public static FavMoviesFra newInstance(String param1, String param2) {
        FavMoviesFra fragment = new FavMoviesFra();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_fav_movies, container, false);
        recyclerView=(RecyclerView)view.findViewById(R.id.recycler_favfra);
        movieList = new ArrayList<>();
        adapter = new FavAdapter(getActivity(), movieList, new FavAdapter.PostItemListener() {
            @Override
    ...
    public void load(){
        ...
        movieDataRepository.getFavMovies()
