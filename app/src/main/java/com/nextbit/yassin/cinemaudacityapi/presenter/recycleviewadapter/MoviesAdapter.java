...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
    ...
    public MoviesAdapter(Context mContext, List<Movie> movieList,PostItemListener itemListener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.thumbnail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mItemListener.onPostClick(item,0);//0 mean is click to open other fragment
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_add_favourite:
                    ...
                    mItemListener.onPostClick(item2,2);// 2 mean add movie to database

                    notifyDataSetChanged();
                    return true;
                case R.id.action_play_next:
                    Toast.makeText(mContext, "show Trailers", Toast.LENGTH_SHORT).show();
                    Movie item = getItem(number); //get item clicked

                    mItemListener.onPostClick(item,1);// 1 mean open  trailer fragment
