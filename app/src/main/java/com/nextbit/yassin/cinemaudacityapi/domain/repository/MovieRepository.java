 ...
 */
package com.nextbit.yassin.cinemaudacityapi.domain.repository;
...
public interface MovieRepository {
  ...
  Observable<TrailerList> movieTrailerStore(String id);

  Observable<ReviewList> movieReviewsStore(String id);
